<footer>
    <div class="container">
        <div class="footer-wrap">
            ...
            <span class="tagline">Long Live the Adventure&trade; </span>
        </div>
        <div class="links">
            <ul>
                <li><a href="http://instagram.com/madebygrizzly" target="_blank">Instagram</a></li>
                <li><a href="https://www.facebook.com/madebygrizzly" target="_blank">Facebook</a></li>
                <li><a href="https://www.twitter.com/madebygrizzly" target="_blank">Twitter</a></li>
            </ul>
        </div>
    </div>
</footer>
